...
// Get only rewiew which have a body
...
<main class="container">
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <img src="./../img/<?= $product->getImage_name() ?>" alt="3d printer" style="max-width: 300px; margin-bottom:20px">
                    <h3 class="card-title"><?= $product->getName() ?> <span class="badge bg-danger rounded pill">$<?= $product->getDisplayPrice() ?></span></h3>
